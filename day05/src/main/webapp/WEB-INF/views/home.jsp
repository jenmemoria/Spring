   ...
   <details>
      ...
      <fieldset>
         <p>
            ...
            원본이 동일하면 해시값도 동일하다는 특성이 있어서, 일치 비교에 사용할수 있다
         </p>
         <p>
            ...
            암호화 방식에 따라, 암호화/복호화 키가 동일한 경우는 대칭키라고 한다<br>
            암호화/복호화 키가 서로 다른 경우는 비대칭키라고 한다<br>
            주로 네트워크 상에서 송신쪽 메시지를 암호화하여 전송하고, 수신쪽에서 복호화하여 나타낸다
         </p>
