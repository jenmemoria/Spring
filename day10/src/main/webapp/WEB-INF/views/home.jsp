...
<script>
	...
	const param = {
		serviceKey: 'gH%2BNkjfRSoH7hZoKaTI7AuP%2B7akx51UJjhfO553oAjcYOB05Hd06X%2B3ULg5ZakssqrSP%2BiWjgtCKez6aFkdHRA%3D%3D',
		pageNo: '1',
		numOfRow: '25',
		resultType: 'json',
	}
...
// 			console.log(arr)
			const tr1 = document.createElement('tr')		// 지역 이름을 배치할 첫번째 줄
