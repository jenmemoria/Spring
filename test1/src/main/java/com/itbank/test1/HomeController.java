...
public class HomeController {
	...
	@GetMapping("/ex01")
	public String ex01(Model model) {	// overloading : 이름이 같지만 매개변수가 다른 함수
	...
	@PostMapping("/ex01")
	public String ex01(int input, Model model) {	// 자바 빈즈 규약을 만족하는 DTO도 처리 가능. (이게 사실상 useBean + setProperty)
		// 매개변수 이름만 맞춰주면 받아오는 거는 문제될 것이 없다.
...
//		System.out.println(n1 + n2 == input);
		...
		return "ex01-result";	// 리턴값은 항상 jsp이름으로 한다. (포워드)
	}
}
